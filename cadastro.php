    ...
    <div id="ban">
        ...
        <img class="bnI" src="imagens/bannerL.png">  
            ...
            <form class="login">
                ...
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label" style="font-size: 25px;">Sonbrenome</label>
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label" style="font-size: 25px;">Data de Nascimento</label>
                    <input type="password" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="mb-3">
                ...
                <button class="Cadastrar" type="button">  Cadastrar  </button>
              </form>
